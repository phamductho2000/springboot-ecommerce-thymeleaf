...
!(function (c) {
  ...
  function x(e) {
    ...
    (this.s = {
      ...
      this.s.ctx.checkboxes || (e.checkboxes = this)._constructor();
  }
  var p = k.fn.dataTable;
  (x.prototype = {
    _constructor: function () {
      for (
        var e,
          ...
          r = !1,
          u = 0;
        u < i.aoColumns.length;
        u++
      ) {
        i.aoColumns[u].checkboxes &&
          ((e = k(d.column(u).header())),
          (h = !0),
          k.isPlainObject(i.aoColumns[u].checkboxes) ||
            (i.aoColumns[u].checkboxes = {}),
          (i.aoColumns[u].checkboxes = k.extend(
            {},
            x.defaults,
            i.aoColumns[u].checkboxes
          )),
          (t = { searchable: !1, orderable: !1 }),
          "" === i.aoColumns[u].sClass
            ? (t.className = "dt-checkboxes-cell")
            : (t.className = i.aoColumns[u].sClass + " dt-checkboxes-cell"),
          null === i.aoColumns[u].sWidthOrig && (t.width = "1%"),
          null === i.aoColumns[u].mRender &&
            (t.render = function () {
              return '<input type="checkbox" class="dt-checkboxes" autocomplete="off">';
            }),
          p.ext.internal._fnColumnOptions(i, u, t),
          e.removeClass("sorting"),
          e.off(".dt"),
          null === i.sAjaxSource &&
            ((c = d.cells("tr", u)).invalidate("data"),
            k(c.nodes()).addClass(t.className)),
          (n.s.data[u] = {}),
          (n.s.dataDisabled[u] = {}),
          n.s.columns.push(u),
          i.aoColumns[u].checkboxes.selectRow &&
            (i._select ? (r = !0) : (i.aoColumns[u].checkboxes.selectRow = !1)),
          i.aoColumns[u].checkboxes.selectAll &&
            (e.data("html", e.html()),
            null !== i.aoColumns[u].checkboxes.selectAllRender &&
              ((s = ""),
              k.isFunction(i.aoColumns[u].checkboxes.selectAllRender)
                ? (s = i.aoColumns[u].checkboxes.selectAllRender())
                : "string" ==
                    typeof i.aoColumns[u].checkboxes.selectAllRender &&
                  (s = i.aoColumns[u].checkboxes.selectAllRender),
              e
                .html(s)
      ...
      h &&
        ...
        k(b).on(
          ...
          function (e) {
            i._fixedHeader &&
              i._fixedHeader.dom.header.floating &&
              n.onClickSelectAll(e, this);
          }
        ),
        k(b).on(
          ...
          function () {
            i._fixedHeader &&
              i._fixedHeader.dom.header.floating &&
              k('input[type="checkbox"]', this).trigger("click");
          }
        ),
    ...
    onDataTablesSelectDeselect: function (e, t, c) {
      ...
      l.s.ignoreSelect ||
        "row" !== t ||
        (null !== (s = l.getSelectRowColIndex()) &&
          ((o = a.cells(c, s)),
          l.updateData(o, s, "select" === e.type),
          l.updateCheckbox(o, s, "select" === e.type),
          l.updateSelectAll(s)));
    },
    onDataTablesStateSave: function (e, t, c) {
      ...
      k.each(s.s.columns, function (e, t) {
        o.aoColumns[t].checkboxes.stateSave &&
          (Object.prototype.hasOwnProperty.call(c, "checkboxes") ||
            (c.checkboxes = []),
          (c.checkboxes[t] = s.s.data[t]));
      });
    },
    ...
    onDataTablesDraw: function () {
      var c = this,
        e = c.s.ctx;
      (e.oFeatures.bServerSide || e.oFeatures.bDeferRender) &&
        c.updateStateCheckboxes({ page: "current", search: "none" }),
    ...
    updateData: function (e, t, c) {
      ...
      o.aoColumns[t].checkboxes &&
        (e.data().each(function (e) {
          c
            ? (o.checkboxes.s.data[t][e] = 1)
            : delete o.checkboxes.s.data[t][e];
        }),
    ...
    updateSelect: function (e, t) {
      var c = this.s.dt;
      this.s.ctx._select &&
        ((this.s.ignoreSelect = !0),
        t ? c.rows(e).select() : c.rows(e).deselect(),
        (this.s.ignoreSelect = !1));
    },
    updateCheckbox: function (e, t, c) {
      ...
      o.length &&
        ...
        k.isFunction(s.aoColumns[t].checkboxes.selectCallback) &&
          s.aoColumns[t].checkboxes.selectCallback(o, c));
    },
    ...
    updateStateCheckboxes: function (e) {
      ...
      t.cells("tr", o.s.columns, e).every(function (e, t) {
        ...
        Object.prototype.hasOwnProperty.call(l.checkboxes.s.data, t) &&
          Object.prototype.hasOwnProperty.call(l.checkboxes.s.data[t], c) &&
          (l.aoColumns[t].checkboxes.selectRow && s && o.updateSelect(e, !0),
          o.updateCheckbox(this, t, !0)),
          s || k("input.dt-checkboxes", this.node()).prop("disabled", !0);
      });
    },
    onClick: function (e, c) {
      var s = this,
        ...
        o = s.s.ctx,
        l = k(c).closest("td"),
        a = l.parents(".DTFC_Cloned").length
          ? t.fixedColumns().cellIndex(l)
          : l,
        n = t.cell(a),
        d = n.index(),
        i = d.column;
      d.row;
      o.aoColumns[i].checkboxes.selectRow
        ? o._select &&
          ("os" === o._select.style
            ? (e.stopPropagation(), n.checkboxes.select(c.checked))
            : setTimeout(function () {
                var e = n.data(),
                  t =
                    Object.prototype.hasOwnProperty.call(s.s.data, i) &&
                    Object.prototype.hasOwnProperty.call(s.s.data[i], e);
                t !== c.checked &&
                  (s.updateCheckbox(n, i, t), s.updateSelectAll(i));
              }, 0))
    ...
    onClickSelectAll: function (e, t) {
      var c = this.s.dt,
        ...
        o = null,
        l = k(t).closest("th");
      (o = l.parents(".DTFC_Cloned").length
        ? c.fixedColumns().cellIndex(l).column
        : c.column(l).index()),
        k(t).data("is-changed", !0),
        c
          .column(o, {
            page:
              s.aoColumns[o].checkboxes &&
              s.aoColumns[o].checkboxes.selectAllPages
                ? "all"
                : "current",
            search: "applied",
          })
          .checkboxes.select(t.checked),
        e.stopPropagation();
    },
    loadState: function () {
      var c,
      ...
      o.oFeatures.bStateSave &&
        ...
        k.each(s.s.columns, function (e, t) {
          c &&
            c.checkboxes &&
            c.checkboxes.hasOwnProperty(t) &&
            o.aoColumns[t].checkboxes.stateSave &&
            (s.s.data[t] = c.checkboxes[t]);
        }));
    },
    updateSelectAll: function (c) {
      ...
      x.aoColumns[c].checkboxes &&
        ...
        k.each(a, function (e, t) {
          u.isCellSelectable(c, t)
            ? Object.prototype.hasOwnProperty.call(u.s.data, c) &&
              Object.prototype.hasOwnProperty.call(u.s.data[c], t) &&
              o++
            : l++;
        }),
        x._fixedHeader &&
          x._fixedHeader.dom.header.floating &&
          (s = k(
        ...
        (i = s.data("is-changed")),
        (h = s.prop("checked")),
        (r = s.prop("indeterminate")),
        (!i && h === n && r === d) ||
          (s.data("is-changed", !1),
          s.prop({ checked: !d && n, indeterminate: d }),
          k.isFunction(x.aoColumns[c].checkboxes.selectAllCallback) &&
            x.aoColumns[c].checkboxes.selectAllCallback(
              s.closest("th").get(0),
              n,
              d
            )));
      ...
      if (e.aanFeatures.i) {
        ...
        if (null !== t) {
          ...
          for (var c in e.checkboxes.s.data[t])
            Object.prototype.hasOwnProperty.call(e.checkboxes.s.data, t) &&
              Object.prototype.hasOwnProperty.call(e.checkboxes.s.data[t], c) &&
              d++;
          k.each(e.aanFeatures.i, function (e, t) {
            ...
            (c = "row"),
              (s = d),
              l.append(
                k('<span class="select-item"/>').append(
                  n.i18n(
                    "select." + c + "s",
                    {
                      _: "%d " + c + "s selected",
    ...
    isCellSelectable: function (e, t) {
      var c = this.s.ctx;
      return (
        !Object.prototype.hasOwnProperty.call(c.checkboxes.s.dataDisabled, e) ||
        !Object.prototype.hasOwnProperty.call(c.checkboxes.s.dataDisabled[e], t)
      );
    },
    getCellIndex: function (e) {
      var t = this.s.dt;
      return this.s.ctx._oFixedColumns
        ? t.fixedColumns().cellIndex(e)
        : t.cell(e).index();
    },
          ...
          this.iterator(
            ...
            function (c, s, e, t, o) {
              ...
              c.aoColumns[s].checkboxes &&
                ...
                (d = []),
                k.each(a, function (e, t) {
                  c.checkboxes.isCellSelectable(s, t) &&
                    (d.push({ row: o[e], column: s }), n.push(o[e]));
                }),
                (l = this.cells(d)),
                c.checkboxes.updateData(l, s, i),
                c.aoColumns[s].checkboxes.selectRow &&
                  c.checkboxes.updateSelect(n, i),
            ...
            function (e, t, c) {
              ...
              e.aoColumns[c].checkboxes &&
                ...
                e.checkboxes.isCellSelectable(c, o) &&
                  ...
                  e.aoColumns[c].checkboxes.selectRow &&
                    e.checkboxes.updateSelect(t, l),
          ...
          this.iterator(
            ...
            function (e, t, c) {
              ...
              e.aoColumns[c].checkboxes &&
                ...
                a
                  ? delete e.checkboxes.s.dataDisabled[c][o]
                  : (e.checkboxes.s.dataDisabled[c][o] = 1),
                (l = s.node()) &&
                  k("input.dt-checkboxes", l).prop("disabled", !a),
                e.aoColumns[c].checkboxes.selectRow &&
                  ...
                  Object.prototype.hasOwnProperty.call(
                    e.checkboxes.s.data[c],
                    o
                  ) &&
                  e.checkboxes.updateSelect(t, a));
            },
            1
          )
        );
    ...
    t.registerPlural(
      ...
      function () {
        return this.iterator(
          "column",
          function (e, t) {
            e.aoColumns[t].checkboxes &&
              ((e.checkboxes.s.data[t] = {}),
